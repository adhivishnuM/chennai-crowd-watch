...
export default function AdminPanel() {
  ...
  return (
    <div className="min-h-screen bg-background pt-14 flex">
      ...
      <motion.aside
        className={cn(
          "fixed left-0 top-14 bottom-0 z-40 bg-card border-r border-border flex flex-col",
      ...
      {/* Main Content */}
      <main className={cn("flex-1 transition-all duration-200", sidebarCollapsed ? "ml-16" : "ml-56")}>
        <motion.div
          key={activePage}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
