...
export default function AdminAnalytics() {
  ...
  const stats = useMemo(() => {
    ...
    const avgCapacity = chennaiLocations.reduce((acc, loc) => acc + (loc.currentCount / loc.capacity), 0) / chennaiLocations.length;
    ...
    chennaiLocations.forEach(loc => levels[loc.crowdLevel]++);
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Locations', value: chennaiLocations.length, icon: MapPin }
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
          ...
          <div className="h-64 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ marginBottom: 40 }}>
              <div className="text-center">
                <span className="text-3xl font-semibold">{chennaiLocations.length}</span>
